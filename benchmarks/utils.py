...
def parse_args():
    ...
    parser.add_argument("--use_full_test_data",
                        action="store_true",
                        default=False,
                        help=("add this flag to use full test data set"))
...
def save_outputs(original_graph,
    ...
    for i, shard in enumerate(original_outputs):
        save_protobuf(shard,
                      output_dir,
                      fname_prefix + "original_batched_inf_out_shard_{}.pb".format(i))
    ...
    for i, shard in enumerate(transformed_outputs):
        save_protobuf(shard,
                      output_dir,
                      fname_prefix + "transformed_batched_inf_out_shard_{}.pb".format(i))
